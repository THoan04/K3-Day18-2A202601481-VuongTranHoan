...
class BM25Search:
    ...
    def index(self, chunks: list[dict]) -> None:
        ...
        for chunk in chunks:
            ...
            self.corpus_tokens.append(segmented.lower().split())
    ...
    def search(self, query: str, top_k: int = BM25_TOP_K) -> list[SearchResult]:
        ...
        scored_indices = [(scores[i], i) for i in range(len(scores)) if scores[i] > 0]
...
class DenseSearch:
    def __init__(self):
        ...
        try:
            ...
            print("  ⚠️ Qdrant connection failed, falling back to local database storage (qdrant_local_db/)")
